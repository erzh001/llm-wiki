...
- **`../deeda/`** — розничный магазин мужской одежды, преимущественно костюмы.
  Дверь + `deeda-vault/`. `private`; клиентский розничный бизнес (ассортимент,
  рынок, клиенты, канал). Общие бизнес-принципы берёт из `biz-knowledge/`.
